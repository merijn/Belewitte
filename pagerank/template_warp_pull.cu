...
__global__ void
vertexPullWarp(int *rev_nodes, int *rev_edges, int *nodes, int size, float *pagerank, float *new_pagerank)
{
...
struct VertexPullWarp {
    static void work()
    { vertexPullWarp<warp, chunk> <<<1, 1, 0 >>>(NULL, NULL, NULL, 0, NULL, NULL); }
};
